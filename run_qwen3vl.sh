...
INPUT_JSONL="/mnt/dhwfile/raise/user/linhonglin/vlm/stages/vqa_data/megascience_4k_unfilt_answer_extracted/shard_0.jsonl"
OUTPUT_JSONL="/mnt/dhwfile/raise/user/linhonglin/vlm/stages/vqa_data/megascience_4k_unfilt_answer_extracted/shard_0_qwen3vl_output.jsonl"
PROMPT_NAME="vqa"
MODEL_NAME="qwen3_vl_nothink"
PROMPT_DIR="prompts"
TEMPERATURE=0.1
TOP_P=0.95
MAX_TOKENS=4096
