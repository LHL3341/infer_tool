...
bash batch_infer.sh \
  --input /mnt/dhwfile/raise/user/qinchonghan/llamafactory/data_processed/AM-Thinking-v1-Distilled-math-qwen3_nothink-convert_amthinking-qwen3_tikzgen_webinstruct_50k/tikz/merged_parsed/success_with_answer.jsonl \
